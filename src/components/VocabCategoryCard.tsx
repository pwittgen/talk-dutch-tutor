...
import { type VocabCategory } from "@/data/vocabData";
...
const VocabCategoryCard = ({ category, index }: VocabCategoryCardProps) => {
  ...
  return (
    ...
    >
      <div className={`w-full h-24 flex items-center justify-center text-5xl ${colorMap[category.color]}`}>
        {category.emoji}
      </div>
      <div className="p-5 w-full">
        ...
        <p className="text-sm font-medium text-secondary italic">{category.dutchTitle}</p>
